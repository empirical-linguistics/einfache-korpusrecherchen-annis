...
```{r csvexpconfig, echo = FALSE, out.width = '80%', out.height = '80%', fig.cap="CSV-Exporter in ANNIS"}
knitr::include_graphics("docs/fig/csv_exporter_config.png")
```
...
```{r importexcel, echo = FALSE, out.width = '80%', out.height = '80%', fig.cap="CSV-Export in Excel kopieren"}
knitr::include_graphics("docs/fig/csv_export_kopieren.gif")
```
...
```{r gridexportoptions, echo = FALSE, out.width = '80%', out.height = '80%', fig.cap="CSV-Export in Excel kopieren"}
knitr::include_graphics("docs/fig/grid_export_options.png")
```
...
```{r gridtoexcel, echo = FALSE, out.width = '80%', out.height = '80%', fig.cap="CSV-Export in Excel kopieren"}
knitr::include_graphics("docs/fig/grid_to_excel.gif")
```
...
```{polyglot, eval=FALSE, message=FALSE, max.height='200px'}
...
```{r excelmacros, echo = FALSE, out.width = '80%', out.height = '80%', fig.cap="CSV-Export in Excel kopieren"}
knitr::include_graphics("docs/fig/excelmacro.gif")
```
